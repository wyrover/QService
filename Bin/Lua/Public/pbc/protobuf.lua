...
function protobuf.encode( message, t , func , ...)
...
function protobuf.decode(typename, buffer, length)
	local ret = {}
...
function protobuf.register( buffer)
	c._env_register(P, buffer)
end

function protobuf.register_file(filename)
